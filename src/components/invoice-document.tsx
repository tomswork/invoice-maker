...
export function InvoiceDocument({
	...
	return (
		<article className="invoice-document mx-auto max-w-[210mm] bg-white px-12 py-10 text-[15px] leading-normal text-black shadow-2xl shadow-black/50 print:max-w-none print:px-0 print:py-0 print:shadow-none">
			...
			{/* Line items */}
			<table className="mb-10 w-full border-collapse text-[12px]">
				<thead>
								...
								<td className="py-2.5 pr-4 align-top text-black">
									{date != null ? (
										<span className="inline-flex w-full">
											<span className="w-[5.25rem] shrink-0 tabular-nums">
												{date}
											</span>
			...
			<section className="mb-10">
				...
				<p className="mb-3 text-[15px] leading-snug text-black">
					Please make payments via direct deposit to:
				</p>
				<p className="text-[15px] leading-snug text-black">
					<span className="font-semibold">Name:</span> {business.accountName}
					<span className="mx-3 text-black/30">·</span>
					<span className="font-semibold">BSB:</span> {business.bsb}
					<span className="mx-3 text-black/30">·</span>
					<span className="font-semibold">ACN:</span> {business.accountNumber}
				</p>
